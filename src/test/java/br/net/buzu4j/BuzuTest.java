...
import br.net.buzu4j.context.BasicMetadataCoderResolver;
...
import br.net.buzu4j.metadata.code.ShortMetadataCoder;
...
import br.net.buzu4j.sample.ppl.Human;
import br.net.buzu4j.sample.ppl.StaticPerson;
import br.net.buzu4j.sample.ppl.Xmen;
import br.net.buzu4j.sample.time.TimePojo;
import br.net.buzu4j.util.PplReader;
import br.net.buzu4j.model.Metaclass;
import br.net.buzu4j.sample.order.*;
...
public class BuzuTest {
    ...
    private void assertJavaVersusKotlin(Object o) {
        ...
        MetaType typeMapper = readMetaType(o.getClass());
    ...
    private static void runLoadByJava(Object o) {
        BasicMetadataLoader loader = new BasicMetadataLoader();
        BasicMetaclassReader reader = new BasicMetaclassReader();
        Metaclass metaclass = reader.read(o.getClass());
        Metadata metadata = loader.load(o, metaclass);

    }

    private static void runLoadByKotlin(Object o) {
        Metadata metadata = loadMetadata(o, readMetaType(o.getClass()));
    }

    public static void main(String[] args) {
        long t0 = System.currentTimeMillis();
        for (int i = 0; i < 1000000; i++) {
            //runLoadByJava(ORDER_INSTANCE);
