package br.net.buzu4j.metadata.build;
...
import static br.net.buzu4j.metadata.build.Layout.NO_PRECISION;
import static br.net.buzu4j.metadata.build.Layout.NO_SIZE;
import static br.net.buzu4j.model.MetaInfoTest.domain;
