...
public class SplitterTest {
    ...
    //@Test
    public void testJavaVersusKotlin() {
        String text = "  nameTest:  (name:S4;age:I5;phones:(ddd:S2;num:S8))  #1-5 ['1=Black','2=White','3=Red'] ='Black' tags";
        //String text = "  nameTest:  S10  #1-5";
        Splitter splitter = new Splitter();
